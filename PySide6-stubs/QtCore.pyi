...
from typing import Any, Callable, ClassVar, Dict, Generator, Generic, IO, Iterable, Iterator, List, Match, Optional, Pattern, Sequence, Set, Text, Tuple, Union, overload, Type
...
class QByteArray(Shiboken.Object):
    ...
    @overload
    def __init__(self, size: int, s: str) -> None: ...
...
class QLocale(Shiboken.Object):
    ...
    class Language(enum.Enum):
        ...
        Kuvi                     : QLocale.Language = ... # 0x158
        LastLanguage             : QLocale.Language = ... # 0x158
...
class QModelIndex(Shiboken.Object):
    ...
    def __copy__() -> None: ...
    def column(self) -> int: ...
    def constInternalPointer(self) -> Any: ...
...
class QObject(Shiboken.Object):
    ...
    @overload
    def connect(self, sender: PySide6.QtCore.QObject, signal: str, member: str, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    @overload
    def connect(self, signal: str, functor: Callable, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    @overload
    def connect(self, signal: str, receiver: PySide6.QtCore.QObject, method: str, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: str, context: PySide6.QtCore.QObject, functor: Callable, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    @overload
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: str, functor: Callable, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    @overload
    @staticmethod
    def connect(sender: PySide6.QtCore.QObject, signal: str, receiver: PySide6.QtCore.QObject, member: str, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    ...
    @overload
    def disconnect(self, receiver: PySide6.QtCore.QObject, member: Union[str, NoneType] = ...) -> bool: ...
    @overload
    def disconnect(self, signal: str, functor: Callable) -> bool: ...
    @overload
    def disconnect(self, signal: str, receiver: PySide6.QtCore.QObject, member: str) -> bool: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def disconnect(sender: PySide6.QtCore.QObject, signal: str, functor: Callable) -> bool: ...
    @overload
    @staticmethod
    def disconnect(sender: PySide6.QtCore.QObject, signal: str, receiver: PySide6.QtCore.QObject, member: str) -> bool: ...
...
class QSize(Shiboken.Object):
    ...
    def __rmul__(self, c: float) -> PySide6.QtCore.QSize: ...
...
class QSizeF(Shiboken.Object):
    ...
    def __rmul__(self, c: float) -> PySide6.QtCore.QSizeF: ...
