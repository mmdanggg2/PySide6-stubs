...
from typing import Any, ClassVar, Dict, Iterable, Iterator, List, Match, Optional, Sequence, Text, Tuple, Type, Union, overload
...
class QAbstractItemDelegate(PySide6.QtCore.QObject):
    ...
    def createEditor(self, parent: PySide6.QtWidgets.QWidget, option: PySide6.QtWidgets.QStyleOptionViewItem, index: Union[PySide6.QtCore.QModelIndex, PySide6.QtCore.QPersistentModelIndex]) -> Optional[PySide6.QtWidgets.QWidget]: ...
...
class QFormLayout(PySide6.QtWidgets.QLayout):
    ...
    def getLayoutPosition(self, layout: PySide6.QtWidgets.QLayout) -> Tuple[int, PySide6.QtWidgets.QFormLayout.ItemRole]: ...
...
class QLineEdit(PySide6.QtWidgets.QWidget):
    ...
    def setSelection(self, arg__1: int, arg__2: int) -> None: ...
    def setText(self, arg__1: Optional[str]) -> None: ...
    @overload
...
class QListWidget(PySide6.QtWidgets.QListView):
    ...
    def setItemWidget(self, item: PySide6.QtWidgets.QListWidgetItem, widget: Optional[PySide6.QtWidgets.QWidget]) -> None: ...
    def setModel(self, model: Optional[PySide6.QtCore.QAbstractItemModel]) -> None: ...
    def setSelectionModel(self, selectionModel: PySide6.QtCore.QItemSelectionModel) -> None: ...
...
class QMessageBox(PySide6.QtWidgets.QDialog):
    ...
    @staticmethod
    def about(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str) -> None: ...
    @staticmethod
    def aboutQt(parent: Optional[PySide6.QtWidgets.QWidget], title: str = ...) -> None: ...
    @overload
    ...
    @overload
    @staticmethod
    def information(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, button0: PySide6.QtWidgets.QMessageBox.StandardButton, button1: PySide6.QtWidgets.QMessageBox.StandardButton = ...) -> PySide6.QtWidgets.QMessageBox.StandardButton: ...
    @overload
    @staticmethod
    def information(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, buttons: PySide6.QtWidgets.QMessageBox.StandardButton = ..., defaultButton: PySide6.QtWidgets.QMessageBox.StandardButton = ...) -> PySide6.QtWidgets.QMessageBox.StandardButton: ...
    ...
    @overload
    @staticmethod
    def question(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, button0: PySide6.QtWidgets.QMessageBox.StandardButton, button1: PySide6.QtWidgets.QMessageBox.StandardButton) -> int: ...
    @overload
    @staticmethod
    def question(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, buttons: PySide6.QtWidgets.QMessageBox.StandardButton = ..., defaultButton: PySide6.QtWidgets.QMessageBox.StandardButton = ...) -> PySide6.QtWidgets.QMessageBox.StandardButton: ...
    def removeButton(self, button: PySide6.QtWidgets.QAbstractButton) -> None: ...
    def resizeEvent(self, event: PySide6.QtGui.QResizeEvent) -> None: ...
    ...
    @overload
    @staticmethod
    def warning(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, button0: PySide6.QtWidgets.QMessageBox.StandardButton, button1: PySide6.QtWidgets.QMessageBox.StandardButton) -> int: ...
    @overload
    @staticmethod
    def warning(parent: Optional[PySide6.QtWidgets.QWidget], title: str, text: str, buttons: PySide6.QtWidgets.QMessageBox.StandardButton = ..., defaultButton: PySide6.QtWidgets.QMessageBox.StandardButton = ...) -> PySide6.QtWidgets.QMessageBox.StandardButton: ...
...
class QProgressDialog(PySide6.QtWidgets.QDialog):
    ...
    def setCancelButtonText(self, text: str) -> None: ...
    def setCancelButton(self, button: Optional[PySide6.QtWidgets.QPushButton]) -> None: ...
...
class QTabBar(PySide6.QtWidgets.QWidget):
    ...
    def setTabButton(self, index: int, position: PySide6.QtWidgets.QTabBar.ButtonPosition, widget: Optional[PySide6.QtWidgets.QWidget]) -> None: ...
...
class QTreeWidget(PySide6.QtWidgets.QTreeView):
    ...
    def setItemWidget(self, item: PySide6.QtWidgets.QTreeWidgetItem, column: int, widget: Optional[PySide6.QtWidgets.QWidget]) -> None: ...
    def setModel(self, model: Optional[PySide6.QtCore.QAbstractItemModel]) -> None: ...
    def setSelectionModel(self, selectionModel: PySide6.QtCore.QItemSelectionModel) -> None: ...
    ...
    def topLevelItem(self, index: int) -> Optional[PySide6.QtWidgets.QTreeWidgetItem]: ...
